...
A Codex plugin providing senior Avaya UC & CC troubleshooting expertise. It contains no runnable code — all components are Markdown files interpreted by the Codex plugin system.
